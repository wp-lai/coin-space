    ...
    <Modal isOpen={isOpen} onClose={onClose} isCentered size="md">
      ...
      <ModalContent background="gray.900" border="1px" borderStyle="solid" borderColor="gray.700" borderRadius="3xl">
        ...
        <ModalFooter
          ...
          p={6}
        >
          <Box color="white" textAlign="left" fontWeight="medium" fontSize="md">
            {myCoins && myCoins.length > 0 && (
              <>
                <Text>You recommended the following coins:</Text>
                <Text>{myCoins.join(' ')}</Text>
              </>
            )}
          </Box>
        </ModalFooter>
